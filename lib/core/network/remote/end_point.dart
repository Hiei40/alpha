...
class Endpoints {
  ...
  // live
 static final String baseUrl = beasUrlCairoOrMa;

//test
// static const baseUrl="http://78.89.159.126:9393/TheOneAboLasheenAPITest";

  static final String getMainCategory = "$baseUrl/api/Category/GetMainCategory";
  static  String register = "$baseUrl/api/Customer/AddCustomer";
  static  String getSubCategory = "$baseUrl/api/Category/GetCategoryByParentId";
  static  String updateUser = "$baseUrl/user/update";
  static  String aboutUS = "$baseUrl/api/AboutUs";
  static  String privacyAndPlo = "$baseUrl/api/Privacy";
  static  String governorates = "$baseUrl/api/Governorates";
  static  String addNewAddress = "$baseUrl/api/Customer/AddCustomerAddress";
