import 'package:alpharapp/Feature/Auth/login/screen/widget/custom_dialog.dart';
import 'package:alpharapp/Feature/Auth/login/screen/widget/wave_background_painter.dart';
                ...
                children: [
                 30.verticalSpace,
                  Padding(
                    ...
                    child: Image.asset(AppAssets.logo,height: 100,width: MediaQuery.sizeOf(context).width,),
                  ),
                  50.verticalSpace,
                  Container(
                    ...
                    SizedBox(
                      ...
                      child: CustomTextFormField(
                        ...
                        ConditionalBuilder(
                          ...
                          builder:(context){
                            return      DefaultButton(backgroundColor: AppColors.mainAppColor,text: 'login'.tr(),function: (){
