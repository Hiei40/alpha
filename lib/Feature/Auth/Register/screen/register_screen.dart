import 'package:alpharapp/Feature/Auth/Register/screen/widget/show_account_exists_warning.dart';
import 'package:alpharapp/Feature/main/Add_New_Address/manager/add_address_state.dart';
import 'package:alpharapp/core/constans/app_assets.dart';
import 'package:conditional_builder_null_safety/conditional_builder_null_safety.dart';
import 'package:alpharapp/Feature/Auth/Register/manager/register_view_state.dart';
                          ...
                          children: [
                            SizedBox(width: MediaQuery.sizeOf(context).width*.7,
                              child: CustomTextFormField(
                                prefix: Padding(
                                  ...
                                  child: SvgPicture.asset(AppAssets.userNameIcon,color:AppColors.mainAppColor),
                                ),
                            ...
                            SizedBox(
                              ...
                              child: CustomTextFormField(
                                prefix: Padding(
                                  padding: const EdgeInsets.all(10.0),
                                  child: SvgPicture.asset(AppAssets.gmailIcon,color: AppColors.mainAppColor,),
                                ),
                            ...
                            SizedBox(
                              ...
                              child: CustomTextFormField(
                                prefix: Padding(
                                  padding: const EdgeInsets.all(10.0),
                                  child: SvgPicture.asset('assets/icons/phone.svg',color: AppColors.mainAppColor),
                                ),
                            ...
                            SizedBox(
                              ...
                              child: CustomTextFormField(
                                prefix: Padding(
                                  padding: const EdgeInsets.all(10.0),
                                  child: SvgPicture.asset(AppAssets.passwordIcon,color: AppColors.mainAppColor),
                                ),
