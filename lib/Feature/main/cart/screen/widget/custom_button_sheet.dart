...
class CustomButtonSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<AddOrderCubit,AddOrderState>(
      ...
      {
           if(state is GetGAllAddressLoading) return const Center(child: CircularProgressIndicator(),);
           if(state is GetGAllAddressError) return const Text("Can not get data");
           return Container(
