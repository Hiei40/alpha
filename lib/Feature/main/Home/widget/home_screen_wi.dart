import 'package:alpharapp/Feature/main/Add%20Order/manager/add_order_cubit.dart';
import 'package:alpharapp/Feature/main/Home/widget/porduct_card.dart';
                ...
                children: [
                  Expanded(
                    ...
                    child: Padding(
                      ...
                      child: InkWell(
                        onTap: () {
                          context.read<AddOrderCubit>().getAllAddress();
                    ...
                    Visibility(
                      ...
                      child: CarouselSlider.builder(
                        ...
                        itemBuilder: (context, index, realIndex) {
                          return InkWell(
                            onTap: () {
                              print(BlocProvider.of<HomeCubit>(
                                context,
