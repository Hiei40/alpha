...
import 'package:alpharapp/Feature/main/Add_New_Address/model/area_model.dart';
import 'package:alpharapp/Feature/main/Home/manager/home_cubit.dart';
                ...
                child: Form(
                  ...
                  40.verticalSpace,
                      ...
                      ConditionalBuilder(
                        ...
                        builder:(context){
                          return
                            DefaultButton(   text:state is AddNewAddressLoading ?"loading": 'add_address'.tr(),function: (){
